...
/**
 * Created by LS on 2017/9/21 12:18.
 * To Be or Not to Be
 */
@WebServlet(name = "ShowOredersByStatusServlet",urlPatterns = "/show_orders_status.view")
public class ShowOredersByStatusServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<OrderListInfo> ordersByStatus = orderListInfoService.ListOrdersByStatus(status);
        String info=null;
